...
class PostsFragment : BaseFragments(R.layout.fragment_posts), BaseInterface {

    private val presenter by moxyPresenter { PostsFragmentPresenter() }
    ...
    override fun initView() {
        ...
        postsRecycler = view!!.findViewById<RecyclerView>(R.id.posts_recycler).apply {
